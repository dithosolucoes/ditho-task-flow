...
import { Calendar, Clock, AlertTriangle, CheckCircle2, Edit, User } from "lucide-react";
...
export function AdminTaskDetails({ 
  task, 
  isOpen, 
  onClose, 
  onComplete, 
  ...
  const handleSave = (updatedTask: AdminTask) => {
    onSave(updatedTask);
    setEditing(false);
  };
        ...
        {editing ? (
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium">Atribuída a: {task.userName}</span>
            </div>
